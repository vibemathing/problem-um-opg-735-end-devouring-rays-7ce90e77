...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-735-end-devouring-rays-7ce90e77-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-735"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-735-end-devouring-rays-7ce90e77-v1",
      "problem_contract_sha256": "91ea0d5a5699b127c6f665f2068f61bb9b4c925474be21fc67604b1ecdaea95d",
      "problem_id": "problem:um-opg-735-end-devouring-rays-7ce90e77",
      "route_id": "route:um-opg-735-end-devouring-rays-7ce90e77-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-735-end-devouring-rays-7ce90e77-source-fidelity-01",
      "graph_id": "graph:um-opg-735-end-devouring-rays-7ce90e77-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-735-end-devouring-rays-7ce90e77-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-735-end-devouring-rays-7ce90e77-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Problem Let $G$ be a graph, $\\omega$ a countable end of $G$, and $K$ an infinite set of pairwise disjoint $\\omega$-rays in $G$. Prove that there is a set $K'$ of pairwise disjoint $\\omega$-rays that devours $\\omega$ such that the set of starting vertices of rays in $K'$ equals the set of starting vertices of rays in $K$."
          },
          "statement_sha256": "1a72d1364ccc88da9d1609ab10b0c89ab1287244cec9fdc5d17a5a90795da06c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-735-end-devouring-rays-7ce90e77-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-735-end-devouring-rays-7ce90e77-root",
      "route_id": "route:um-opg-735-end-devouring-rays-7ce90e77-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-735-d79b91445bb9",
        "url": "https://www.unsolvedmath.com/problems/OPG-735"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
